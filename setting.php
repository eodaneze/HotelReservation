         ...
         <div class="row">
              <div class="col-lg-4 py-4" style="background-color: #0F172B;">
                   <div class="account_left mb-3">
                       <a href="./myAccount.php"><p style="color: white;  padding: 10px"><i class="fa fa-user"></i> Account Overview</p></a>
                   </div>
                   <div class="account_left mb-3">
                       <a href="./myBookings.php"><p style="color: white;  padding: 10px"><i class="fa-solid fa-house"></i> Bookings</p></a>
                   </div>
                   <div class="account_left mb-3">
                       <a href=""><p style="color: #EEA01E; background-color: #f0f0f0; padding: 10px"><i class="fa-solid fa-gear"></i> Settings</p></a>
                   </div>
                   <div class="account_left mb-3">
