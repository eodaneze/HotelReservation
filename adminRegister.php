        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase">Admin registration</h6>
                </div>
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form action="./includes/userRegister.php" method="post">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="file" name="file" class="form-control" id="email" placeholder="Your Address">
                                            <label for="email">Your Profile</label>
                                        </div>
                                    </div>
